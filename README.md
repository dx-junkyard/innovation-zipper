...
- **構造 (Structural Analysis)**: 現状の課題構造（主体、痛点、制約、悪循環）を青色で表示。
- **飛躍 (Variants)**: 制約や主体に対する強制的な発想（亜種）を緑色で表示。
- **再結合 (Synthesis)**: 亜種を組み合わせて導き出された新しい仮説を赤色で表示し、統合（ジッパーが閉じる）される様子を表現します。
